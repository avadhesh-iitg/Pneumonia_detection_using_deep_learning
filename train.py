...
from keras.layers import Dense, Input, Conv2D,MaxPooling2D,Dropout,Flatten,Activation,BatchNormalization,add
...
train_dir = base_dir+"\\Dataset\\train" # 
val_dir = base_dir+"\\Dataset\\val"     # -- Directories for data
test_dir = base_dir+"\\Dataset\\test"   # 
